...
import com.caxerx.mc.crystalpoints.cache.CrystalPointsUser;
...
public class BalanceMessageRunnable extends BukkitRunnable {
    ...
    public void run() {
        try {
            ...
            new BalanceMessageRunnable(sender, player).runTaskLaterAsynchronously(CrystalPoinrts.getInstance(), 20L);
        }
    }
}
